...
let SiteRuleService = class SiteRuleService {
    ...
    find(where) {
        return __awaiter(this, void 0, void 0, function* () {
            const siteRules = yield siteRule_model_1.default.findAll({
    ...
    findOne(where) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const siteRule = yield siteRule_model_1.default.findOne({
                where: where, include: [site_model_1.default]
            });
            return siteRule;
        });
    ...
    updateOne(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield siteRule_model_1.default.update(body, { where: { 'id': id } });
        });
    }
