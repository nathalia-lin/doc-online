...
const logExam_dto_1 = require("../dto/logExam.dto");
const logExam_service_1 = require("../service/logExam.service");
let LogExamController = class LogExamController {
    constructor(logExamService) {
    ...
    deleteOne(logExamId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.logExamService.deleteOne(logExamId);
        });
    }
};
__decorate([
    ...
    __metadata("design:paramtypes", [logExam_dto_1.CreateLogExamDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], LogExamController.prototype, "deleteOne", null);
LogExamController = __decorate([
    common_1.Controller('logexam'),
    __metadata("design:paramtypes", [logExam_service_1.LogExamService])
], LogExamController);
exports.LogExamController = LogExamController;
