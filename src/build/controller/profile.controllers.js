...
let ProfileController = class ProfileController {
    ...
    create(createProfileDot) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.profileService.create(createProfileDot);
        });
    }
    show() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.profileService.find({});
        });
    }
    showOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.profileService.findOne(id);
        });
    }
    update(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.profileService.updateOne(id, body);
        });
    }
    deleteOne(profileId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.profileService.deleteOne(profileId);
        });
    }
};
__decorate([
