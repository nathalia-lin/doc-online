...
let SiteRuleController = class SiteRuleController {
    constructor(siteRuleService) {
...
SiteRuleController = __decorate([
    ...
    __metadata("design:paramtypes", [siteRule_service_1.SiteRuleService])
], SiteRuleController);
exports.SiteRuleController = SiteRuleController;
