...
let PlanController = class PlanController {
    ...
    show() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.planService.find({});
        });
    }
    showOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.planService.findOne(id);
        });
    }
    update(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.planService.updateOne(id, body);
        });
    }
    deleteOne(planId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.planService.deleteOne(planId);
        });
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PlanController.prototype, "show", null);
__decorate([
    common_1.Get(':id'),
